...
abstract class $RegisterCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? status, String? token, String? redirect});
}
...
class _$_Register implements _Register {
  _$_Register({this.status, this.token, this.redirect});
  ...
  @override
  String toString() {
    return 'Register(status: $status, token: $token, redirect: $redirect)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, status, token, redirect);
...
abstract class _Register implements Register {
  factory _Register(
      {final String? status,
      final String? token,
      final String? redirect}) = _$_Register;
